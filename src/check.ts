...
var init = async function () {
  for (let i in uncles) {
    ...
    for (let k in block954.transactions) {
      if (
        utils.getAddress(block954.transactions[k].from) ===
          "0xB7d691867E549C7C54C559B7fc93965403AC65dF" ||
        utils.getAddress(block954.transactions[k].from) ===
          "0x7aA0426F10C7603BBFb8CEB8AFb8d8c329ccfE8b" ||
        utils.getAddress(block954.transactions[k].from) ===
